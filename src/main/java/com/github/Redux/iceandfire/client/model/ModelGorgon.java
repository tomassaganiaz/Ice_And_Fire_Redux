...
public class ModelGorgon extends ModelDragonBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, EntityGorgon entity) {
		...
		AdvancedModelRenderer[][] ALL_SNAKES = {SNAKEL1, SNAKEL2, SNAKEL3, SNAKEL4, SNAKER1, SNAKER2, SNAKER3, SNAKER4};
		...
		for (AdvancedModelRenderer[] snake : ALL_SNAKES) {
			this.chainFlap(snake, speed_idle, degree_idle * 0.75F, -3, f2, 1);
			this.chainSwing(snake, speed_idle, degree_idle * 0.75F, -3, f2, 1);
		}
