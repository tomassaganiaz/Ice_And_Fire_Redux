...
public class ModelAmphithere extends ModelDragonBase {
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        for (int[] angles : new int[][]{{32, 170}, {15, 45}, {32, 170}, {15, 45}}) {
            animator.startKeyframe(5);
            wingBlastPose();
            this.rotateMinus(animator, WingR, angles[0], 0, angles[1]);
            this.rotateMinus(animator, WingL, angles[0], 0, -angles[1]);
            animator.endKeyframe();
        }
    ...
    private void flapWingPair(AdvancedModelRenderer left, AdvancedModelRenderer right, float speed, float degree, float f, float f1) {
        this.flap(left, speed, degree, false, 0, 0, f, f1);
        this.flap(right, speed, -degree, false, 0, 0, f, f1);
    }
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
        ...
        flapWingPair(WingL, WingR, speed_fly, degree_flap, f2, 1);
        flapWingPair(WingL2, WingR2, speed_fly, degree_flap, f2, 1);
        {
