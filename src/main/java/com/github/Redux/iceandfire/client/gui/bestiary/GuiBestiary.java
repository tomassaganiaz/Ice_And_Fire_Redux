...
public class GuiBestiary extends GuiScreen {
	...
	public void drawPerPage(int bookPages) {
		switch (this.pageType) {
			case INTRODUCTION: drawIntroductionPage(); break;
			case FIREDRAGON: drawFireDragonPage(); break;
			case FIREDRAGONEGG: drawFireDragonEggPage(); break;
			case ICEDRAGON: drawIceDragonPage(); break;
			case ICEDRAGONEGG: drawIceDragonEggPage(); break;
			case LIGHTNINGDRAGON:
			case LIGHTNINGDRAGONEGG:
			case HYDRA:
			case DREAD_MOBS:
			case DRAGONFORGE: drawGenericTextPage(); break;
			case TAMEDDRAGONS: drawTamedDragonsPage(); break;
			case MATERIALS: drawMaterialsPage(); break;
			case ALCHEMY: drawAlchemyPage(); break;
			case VILLAGERS: drawVillagersPage(); break;
			case HIPPOGRYPH: drawHippogryphPage(); break;
			case GORGON: drawGorgonPage(); break;
			case PIXIE: drawPixiePage(); break;
			case CYCLOPS: drawCyclopsPage(); break;
			case SIREN: drawSirenPage(); break;
			case HIPPOCAMPUS: drawHippocampusPage(); break;
			case DEATHWORM: drawDeathwormPage(); break;
			case COCKATRICE: drawCockatricePage(); break;
			case STYMPHALIANBIRD: drawStymphalianBirdPage(); break;
			case TROLL: drawTrollPage(); break;
			case MYRMEX: drawMyrmexPage(); break;
			case AMPHITHERE: drawAmphitherePage(); break;
			case SEASERPENT: drawSeaSerpentPage(); break;
		}
	}
	...
	private void drawFireDragonPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
	...
	private void drawFireDragonEggPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
	...
	private void drawIceDragonPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
	...
	private void drawIceDragonEggPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
	...
	private void drawGenericTextPage() {
		drawFromTxt();
		writeFromTxt();
	}

	private void drawTamedDragonsPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
			drawImage(DRAWINGS_0, 144, 90, 389, 1, 50, 50);
	...
	private void drawMaterialsPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
	...
	private void drawVillagersPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
	...
	private void drawHippogryphPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.pushMatrix();
	...
	private void drawHippocampusPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
	...
	private void drawDeathwormPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
	...
	private void drawCockatricePage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
	...
	private void drawStymphalianBirdPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(1.5F, 1.5F, 1F);
	...
	private void drawAmphitherePage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
	...
	private void drawSeaSerpentPage() {
		if (bookPages == 0) {
			GlStateManager.pushMatrix();
			GlStateManager.scale(0.75F, 0.75F, 0.75F);
