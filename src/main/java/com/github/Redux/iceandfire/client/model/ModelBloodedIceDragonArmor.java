...
/** Modelo 3D de Blooded Ice Dragon Armor */


public class ModelBloodedIceDragonArmor extends ModelIceDragonArmor {
	
	private static final ResourceLocation[] BLOOD_FRAMES = frames("iced", false);
	private static final ResourceLocation[] BLOOD_FRAMES_LEGS = frames("iced", true);
