...
public class ModelStymphalianBird extends ModelDragonBase {
    ...
    private AdvancedModelRenderer createToe(float x, float y, float z, float rotX, float rotY, float rotZ) {
        AdvancedModelRenderer toe = new AdvancedModelRenderer(this, 0, 43);
        toe.mirror = true;
        toe.setRotationPoint(x, y, z);
        toe.addBox(-0.5F, -0.5F, -0.7F, 1, 4, 2, 0.0F);
        this.setRotateAngle(toe, rotX, rotY, rotZ);
        return toe;
    }
    ...
    public ModelStymphalianBird() {
        ...
        this.ToeL4_1 = createToe(0.0F, 10.8F, 0.2F, -1.593485607070823F, 0.6108652381980153F, 0.0F);
        ...
        this.ToeR2 = createToe(0.0F, 10.8F, 0.2F, -1.593485607070823F, -0.6108652381980153F, 0.0F);
        ...
        this.ToeL1 = createToe(0.0F, 11.1F, 0.2F, -2.0032889154390916F, 3.141592653589793F, 0.0F);
        this.ToeR3 = createToe(0.0F, 10.8F, -0.7F, -1.5481070465189704F, 0.0F, 0.0F);
        ...
        this.ToeR1 = createToe(0.0F, 11.1F, 0.2F, -2.0032889154390916F, 3.141592653589793F, 0.0F);
        ...
        this.ToeL2 = createToe(0.0F, 10.8F, 0.2F, -1.593485607070823F, 0.6108652381980153F, 0.0F);
        ...
        this.ToeL3 = createToe(0.0F, 10.8F, -0.7F, -1.593485607070823F, 0.0F, 0.0F);
        ...
        this.ToeL4 = createToe(0.0F, 10.8F, 0.2F, -1.593485607070823F, -0.6108652381980153F, 0.0F);
